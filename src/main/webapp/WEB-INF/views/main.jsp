							...
							<%-- EL : ${이름} , scope에 저장된 값을 꺼내서 출력 --%>
								...
								<div id="wrapper">
									...
									<header id="header" class="alt">
										<a href="index.html" class="logo"><strong>Forty</strong> <span>by HTML5
												UP</span></a>
										<nav>
										    <%-- user 정보가 비워져있으면 로그인 출력 --%>
										    <c:if test="${empty user}">
										        <a href="#menu">로그인</a>
										     </c:if>

											<%-- Ex03 로그인 시, 개인정보수정, 로그아웃 메뉴를 출력해봅시다. --%>
												<c:if test="${!empty user}">
									...
									<section id="banner" class="major">
										<div class="inner">
											<header class="major">
												...
												<%-- Ex04.로그인 후 로그인 한 사용자의 이메일을 출력해봅시다.(세션에서 가져오기) --%>
												<c:if test="${!empty user}">
												</c:if>
									...
									<section id="contact">
										<div class="inner">
											...
											<%-- Ex05.로그인 한 사용자의 이메일, 전화번호, 주소를 출력해봅시다. --%>
												<section class="split">
													<section>
